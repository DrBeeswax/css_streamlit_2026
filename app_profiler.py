...
st.write(f"**Name:** ""Dr Bee")
st.write(f"**Field of Research:** Computational Chemistry")
st.write(f"**Institution:** University of Stellenbosch")
...
st.write(f"You can reach {'Dr Belle'} at {'belle@sun.ac.za'}.")
